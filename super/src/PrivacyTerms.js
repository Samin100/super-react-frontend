...
<h3 className="text-center top-title">PRIVACY POLICY</h3>
<p>
This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from gosuper.io (the “Site”).
</p>
...
<ul>
  <li><p>“Cookies” are data files that are placed on your device or computer and often include an anonymous unique identifier. For more information about cookies, and how to disable cookies, visit <a href="http://www.allaboutcookies.org">http://www.allaboutcookies.org</a>.</p></li>
...
<ul>
  ...
  <li><p>Screen our orders for potential risk or fraud.</p></li>
  <li><p>When in line with the preferences you have shared with us, provide you with information or advertising relating to our products or services.</p></li>
</ul>
<p>
...
<h5>CONTACT US</h5>
<p>
For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at support@gosuper.io.
</p>
</div>
  ...
  render() {
    return (
      <div className="landing-wrapper">
        <Header />
        <div className="privacy-terms-container">
      <h3 class="text-center top-title">TERMS OF SERVICE</h3>

<h5>OVERVIEW</h5>

<p>
This website is operated by Super. Throughout the site, the terms “we”, “us” and “our” refer to Super. Super offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
...
<p>
Your submission of personal information through the store is governed by our Privacy Policy. To view our Privacy Policy, click <a href="/privacy">here</a>.
</p>
...
<p>
You agree to indemnify, defend and hold harmless Super and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
</p>
...
<p>
These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of San Francisco, California.
</p>
...
<p>
Questions about the Terms of Service should be sent to us at support@gosuper.io.
</p>
    </div>
    <div className="landing-footer">
      <img className="header-logo footer-logo" src={logo_black} alt="super" />
